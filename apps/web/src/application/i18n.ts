...
export const en = {
  ...
  scopesHint: 'Scopes separated by commas',
  clearAll: 'Clear all',
...
export const ptBR: Record<keyof typeof en, string> = {
  ...
  pagination: 'Paginação do catálogo',
  perPage: 'por página',
  of: 'de',
  signIn: 'Entrar',
  signOut: 'Sair',
  ...
  activate: 'Ativar',
  update: 'Atualizar',
  create: 'Criar conta de serviço',
  externalSubject: 'Identificador externo',
  scopesHint: 'Escopos separados por vírgulas',
  clearAll: 'Limpar tudo',
  removeFilter: 'Remover filtro {field} {value}',
